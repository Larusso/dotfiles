# Generated by Powerlevel10k configuration wizard on 2021-01-09 at 21:36 CET.
...
() {
  ...
  # typeset -g POWERLEVEL9K_HOME_FOLDER_ABBREVIATION="%F{red} $(print_icon 'HOME_ICON') %F{black}"
